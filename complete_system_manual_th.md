...
อัปเดตล่าสุด: 2026-05-27 22:06:04 (+07:00)  
...
1. **กลไกการขอความยินยอม (Consent Management):**
   - ก่อนที่นักศึกษาจะทำการกรอกฟอร์มลงทะเบียนขอเข้าใช้งานห้องเรียน หน้าแรกของเว็บแอปพลิเคชันจะแสดงกล่องข้อความชี้แจงจุดประสงค์และเงื่อนไขการใช้ข้อมูล พร้อมปุ่มกดยอมรับความยินยอมอย่างชัดเจน (Explicit Consent) หากผู้ใช้ปฏิเสธ ระบบจะไม่ทำการส่งหรือเก็บข้อมูลใดๆ ลงฐานข้อมูล
...
ในการนำระบบไปติดตั้งใช้งานจริงในสถานศึกษาหรือห้องปฏิบัติการของคณะวิศวกรรมศาสตร์ นักศึกษาและผู้ผ่านเข้าออกทุกคนต้องปฏิบัติตามข้อตกลงการใช้บริการดังนี้:
...
2. **นโยบายการห้ามเดินตามหลังโดยไม่สแกนสิทธิ์ (Anti-Tailgating Policy):**
   - นักศึกษาทุกคนต้องทำการสแกนประวัติการยืนยันตนและรอผลอนุมัติในการเข้าออกรายคน ห้ามมิให้เดินตามหลังผู้อื่นที่ประตูถูกเปิดค้างไว้โดยไม่มีการบันทึกประวัติลงตาราง `access_logs` หากเกิดเหตุขัดข้องทางทรัพย์สินส่วนกลาง บุคคลสุดท้ายที่ปรากฏประวัติในระบบจะถือเป็นผู้รับผิดชอบหลักในการให้ข้อมูลแก่คณะวิศวกรรมศาสตร์
3. **ขอบเขตความรับผิดชอบและการจำกัดความรับผิด (Limitation of Liability):**
   - คณะวิศวกรรมศาสตร์และทีมผู้พัฒนาระบบควบคุมนี้ จะไม่รับผิดชอบต่อความสูญหาย เสียหาย หรือการถูกโจรกรรมของทรัพย์สินส่วนตัวของนักศึกษาที่นำเข้าไปเก็บรักษาภายในห้องเรียนทุกกรณี 
...
นโยบายความเป็นส่วนตัวนี้ชี้แจงกระบวนการจัดการข้อมูลส่วนบุคคล (PII) ของระบบ เพื่อความโปร่งใสและปกป้องผลประโยชน์ของนักศึกษาตามหลักมาตรฐานสากล:
