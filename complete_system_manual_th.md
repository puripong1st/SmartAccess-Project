...
1. **กลไกการขอความยินยอม (Consent Management):**
   ...
   - ระบบทำการบันทึกค่าความยินยอมไว้ใน `localStorage` ด้วยคีย์ `rmutp_cookie_consent` เพื่อจดจำเซสชันการตัดสินใจของผู้ใช้ และส่งสัญญาณประสานงานผ่าน Custom Event `rmutp_cookie_consent_changed` ไปยังหน้าหลักเพื่อสลับหน้าจอการลงทะเบียนโดยไม่ต้องรีโหลดหน้าเว็บ
...
ในการนำระบบไปติดตั้งใช้งานจริงในสถานศึกษาหรือห้องปฏิบัติการของคณะวิศวกรรมศาสตร์ นักศึกษาและผู้ผ่านเข้าออกทุกคนต้องปฏิบัติตามข้อตกลงการใช้บริการดังนี้ โดยข้อกำหนดเหล่านี้ได้รับการเผยแพร่อย่างชัดเจนบนเว็บแอปพลิเคชันที่หน้า [terms/page.tsx](file:///c:/Users/aunkh/OneDrive/Desktop/Project/my-app/app/terms/page.tsx):
