...
* **GPIO 5 (BUZZER_PIN)**: ต่อเข้ากับบัซเซอร์เสียงแจ้งเตือนแบบ Active (ส่งเสียงตามเหตุการณ์ต่างๆ)
* **GPIO 2 (STATUS_LED_PIN)**: สัญญาณไฟแสดงการเชื่อมต่อ Wi-Fi ท้องถิ่น (กระพริบระลอกคลื่นค้นหาสัญญาณ / ติดค้างคงที่เมื่อพร้อมให้บริการ)
