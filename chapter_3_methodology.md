# รายงานวิจัยบทที่ 3 — วิธีดำเนินงานและออกแบบระบบควบคุมประตูอัจฉริยะ (SmartAccess)

เอกสารวิชาการฉบับนี้จัดขึ้นตามโครงสร้างมาตรฐานวิทยานิพนธ์/โครงการวิจัย (Chapter 3: Research Methodology & System Design) สำหรับนำไปใช้ประกอบการรายงานผลการพัฒนาระบบควบคุมการเข้าใช้ห้องปฏิบัติการ คณะครุศาสตร์ Innovative system for managing access rights and controlling classroom access via wireless network
...
* **ขั้นตอนการยื่นขอสิทธิ์**:
  ...
  4. หากสแกนผ่าน ระบบจะทำเครื่องหมายไว้ในแท็บความจำเครื่อง (`sessionStorage.setItem("smartaccess_qr_verified", "1")`) ป้องกันการกดรีเฟรชหน้าแล้วหลุดล็อก
