  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p>
            ในการนำระบบควบคุมการเข้าออกห้องปฏิบัติการอัจฉริยะ <strong style={{ color: "#FFFFFF" }}>RMUTP ACCS</strong> ไปติดตั้งใช้งานจริงในสถานศึกษาหรือห้องปฏิบัติการของคณะวิศวกรรมศาสตร์ นักศึกษา บุคลากร และผู้ผ่านเข้าออกทุกคนต้องปฏิบัติตามข้อกำหนดและเงื่อนไขการใช้บริการดังนี้อย่างเคร่งครัด เพื่อความมั่นคงปลอดภัยสูงสุดของสถานศึกษาและทรัพย์สินส่วนรวม:
          </p>
          ...
          <div>
            ...
            <p>
              สิทธิ์การเข้าใช้งานห้องปฏิบัติการผ่านระบบสแกนคิวอาร์โค้ดนี้ เป็นสิทธิ์เฉพาะตัวบุคคลของนักศึกษาหรือเจ้าหน้าที่ที่ได้รับการอนุมัติอย่างถูกต้องเท่านั้น <strong style={{ color: "#FFFFFF" }}>ห้ามมิให้นักศึกษานำโทเคน (Token) คิวอาร์โค้ด หรือสิทธิ์ผ่านทางชั่วคราว (Bypass Token) ไปแบ่งปัน ส่งต่อ หรืออนุญาตให้บุคคลอื่นที่ไม่มีสิทธิ์ใช้เพื่อเปิดประตูผ่านทางเข้า</strong> การกระทำดังกล่าวจะถือว่าเป็นการละเมิดนโยบายความปลอดภัยขั้นร้ายแรง
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              นักศึกษาทุกคนต้องทำการสแกนประวัติการยืนยันตนและรอผลการอนุมัติในระบบรายคนก่อนเข้าสู่ห้องเรียน <strong style={{ color: "#FFFFFF" }}>ห้ามมิให้เดินตามหลังผู้อื่น (Tailgating) ที่ประตูถูกเปิดค้างไว้โดยไม่มีการลงบันทึกประวัติลงตาราง access_logs</strong> หากเกิดกรณีทรัพย์สินส่วนกลางสูญหายหรือเสียหาย บุคคลสุดท้ายที่ปรากฏประวัติเข้าห้องในระบบจะถือเป็นผู้รับผิดชอบหลักในการให้ข้อมูลการสอบสวนแก่คณะวิศวกรรมศาสตร์
            </p>
          </div>
