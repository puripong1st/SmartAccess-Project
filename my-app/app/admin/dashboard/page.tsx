...
"-----END CERTIFICATE-----\\n";
  ...
  ==============================================================
*/
// #define WOKWI_SIM        // <-- เลิกคอมเมนต์หากต้องการรันบน Wokwi Simulator เท่านั้น (ห้ามรันใน Production!)
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (String(server_url).startsWith("https://")) {
      ...
      if (client) {
        client->setCACert(root_ca_cert); // ตรวจสอบใบรับรอง Root CA ของเซิร์ฟเวอร์คลาวด์จริงเพื่อความปลอดภัยสูงสุด (ป้องกัน MitM)
