// Centralized SVG icon set — replaces UI emojis for a more professional look.
// All icons are 24×24 viewBox, stroke-based (Lucide/Feather style), inherit currentColor.
// Pass props: size, strokeWidth, className, style.
...
export const IconCookie = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconCog = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconUnlock = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
    <rect x="3" y="11" width="18" height="11" rx="2" />
...
export const IconHourglass = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
    <path d="M6 2h12" />
    <path d="M6 22h12" />
...
export const IconDoor = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconGraduation = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconMonitor = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconQrCode = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconWifi = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconDatabase = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconAt = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
...
export const IconLightbulb = ({ size, ...p }: IconProps) => (
  <svg {...base(size)} {...p}>
    <path d="M9 18h6" />
    <path d="M10 22h4" />
