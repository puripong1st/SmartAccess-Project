...
## ภาพรวมโครงการ
ระบบควบคุมการเข้าถึงห้องเรียนสำหรับมหาวิทยาลัยเทคโนโลยีราชมงคลพระนคร (RMUTP) ที่ใช้เทคโนโลยี ESP32 หรือ Wokwi Simulator ในการควบคุมประตูห้องเรียน โดยมีการลงทะเบียนนักศึกษาผ่านเว็บแอปพลิเคชัน Next.js และใช้ฐานข้อมูล MySQL ในการจัดการข้อมูล

## สถาปัตยกรรมระบบ
```
┌─────────────────┐    ┌──────────────────┐    ┌──────────────────┐
│   เว็บแอปพลิเคชัน    │    │   ฐานข้อมูล MySQL    │    │   ESP32 / Wokwi    │
...
2. **ไลบรารีช่วยเหลือ (lib/)**
   ...
   - `db.ts`: การเชื่อมต่อ MySQL pool และการเริ่มต้นฐานข้อมูล
...
* **ช่องโหว่เดิม**: ใน API `/api/logs` ผู้ใช้ที่มีสิทธิ์สามารถส่งพารามิเตอร์จำกัดข้อมูลเป็นจำนวนมหาศาล เช่น `?limit=99999999` ซึ่งอาจนำไปสู่การโหลดตารางบันทึกการเข้าออกทั้งหมดจากฐานข้อมูล MySQL (Database Exhaustion)
* **การแก้ไข (Patched)**:
