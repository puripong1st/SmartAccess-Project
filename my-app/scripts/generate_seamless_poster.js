...
async function buildSeamlessBalancedPoster() {
  ...
  console.log('Building Truly Full-Height Proportional A4 Poster HTML...');
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .tft-top-bar .brand { color: #E2E8F0; font-size: 2.3mm; font-weight: 800; }
    .tft-top-bar .status { font-size: 2mm; padding: 0.3mm 1.5mm; background: rgba(16, 185, 129, 0.2); color: #10B981; border-radius: 0.8mm; font-weight: 700; }
    .tft-body-row {
      display: flex;
      align-items: center;
      padding: 1.6mm 2mm;
    ...
    .tft-room-box { flex: 1; }
    .tft-room-box .lbl { color: #94A3B8; font-size: 2mm; font-weight: 700; text-transform: uppercase; }
    .tft-room-box .code { color: #38BDF8; font-size: 5.2mm; font-weight: 900; line-height: 1.1; margin-top: 0.2mm; }
    .tft-room-box .sub { color: #CBD5E1; font-size: 2.3mm; margin-top: 0.2mm; }
    .tft-bot-bar {
      background: #0A0B10;
      padding: 1mm 2mm;
      display: flex;
    ...
    .tft-bot-bar span { color: #64748B; font-size: 2mm; }
    ...
    .b-item .ico { color: #38BDF8; font-size: 2.8mm; line-height: 1; margin-top: 0.2mm; }
    .b-item strong { color: #F8FAFC; }

    /* ─── STEP 2 CONTENT (EXPANDED HERO FORM) ─── */
    .step2-showcase-grid {
      display: grid;
      grid-template-columns: 46mm 1.18fr 0.95fr;
      gap: 3.8mm;
      align-items: center;
      background: #05070E;
      border-radius: 3mm;
    ...
    .unlock-txt-top { color: #10B981; font-size: 2.9mm; font-weight: 900; letter-spacing: 0.3px; }
    .unlock-txt-mid { color: #FCD34D; font-size: 2.2mm; font-weight: 800; margin-top: 0.2mm; }
    .unlock-name-pill {
      margin-top: 1mm;
      background: rgba(255, 255, 255, 0.08);
    ...
    .line-icon-box {
      ...
      align-items: center;
      justify-content: center;
      box-shadow: 0 0 10px rgba(6, 199, 85, 0.6);
      flex-shrink: 0;
    }
    .line-icon-box svg {
      width: 4.6mm;
...
<body>
        ...
        <section class="card-shell purple-theme">
          ...
          <div class="step3-flex-col">
            ...
            <div class="live-status-box">
              ...
              <span style="color:#94A3B8; font-size:2.3mm;">เช็กคิวอัตโนมัติทุก 3 วินาที</span>
            </div>
  ...
  console.log(`Saved Seamless HTML poster: ${htmlPath}`);
  ...
  try {
    ...
    console.log('=== Seamless Balanced Poster Generated Successfully! ===');
  } catch (err) {
    console.error('Error generating perfect poster:', err);
  } finally {
    await browser.close();
  }
}

buildSeamlessBalancedPoster();
