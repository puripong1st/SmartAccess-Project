...
async function buildBalancedPoster() {
  ...
  console.log('Building Perfectly Distributed A4 Poster HTML...');
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ─── 3. WORKFLOW CARDS (PERFECTLY PROPORTIONED) ─── */
    .workflow-wrap {
      position: relative;
      z-index: 10;
      display: flex;
    ...
    .tft-top-bar .brand { color: #E2E8F0; font-size: 2.1mm; font-weight: 800; }
    .tft-top-bar .status { font-size: 1.8mm; padding: 0.2mm 1.4mm; background: rgba(16, 185, 129, 0.2); color: #10B981; border-radius: 0.8mm; font-weight: 700; }
    .tft-body-row {
      display: flex;
      align-items: center;
      padding: 1.4mm 1.8mm;
    ...
    .tft-room-box .code { color: #38BDF8; font-size: 4.8mm; font-weight: 900; line-height: 1.1; margin-top: 0.2mm; }
    .tft-room-box .sub { color: #CBD5E1; font-size: 2.1mm; margin-top: 0.2mm; }
    .tft-bot-bar {
      background: #0A0B10;
      padding: 0.9mm 1.8mm;
      display: flex;
    ...
    .b-item .ico { color: #38BDF8; font-size: 2.6mm; line-height: 1; margin-top: 0.2mm; }
    .b-item strong { color: #F8FAFC; }

    /* ─── STEP 2 CONTENT (EXPANDED HERO FORM) ─── */
    .step2-showcase-grid {
      display: grid;
      grid-template-columns: 42mm 1.15fr 0.95fr;
      gap: 3.6mm;
      align-items: center;
      background: #05070E;
      border-radius: 2.8mm;
    ...
    .phone-mockup-wrap {
      ...
      box-shadow: 0 6px 20px rgba(0, 0, 0, 0.8), 0 0 16px rgba(124, 58, 237, 0.35);
      display: flex;
      flex-direction: column;
      height: 56mm;
    }
    ...
    .unlock-txt-top { color: #10B981; font-size: 2.7mm; font-weight: 900; letter-spacing: 0.3px; }
    .unlock-txt-mid { color: #FCD34D; font-size: 2.1mm; font-weight: 800; margin-top: 0.2mm; }
    .unlock-name-pill {
      margin-top: 0.9mm;
      background: rgba(255, 255, 255, 0.08);
    ...
    /* LINE Contact Support Strip */
    .line-support-strip {
      background: linear-gradient(90deg, rgba(6, 199, 85, 0.15) 0%, rgba(15, 23, 42, 0.8) 50%, rgba(6, 199, 85, 0.15) 100%);
      border: 1.2px solid rgba(6, 199, 85, 0.4);
      border-radius: 2.2mm;
      padding: 1.4mm 3mm;
      display: flex;
      align-items: center;
...
<body>
  ...
  <div class="poster-canvas">
    ...
    <main class="workflow-wrap">
      ...
      <!-- STEP 2: FILL REGISTRATION (EXPANDED HERO SHOWCASE) -->
      <section class="card-shell purple-theme">
        <div class="card-header-flex">
          <div class="step-badge-group">
        ...
        <section class="card-shell purple-theme">
          ...
          <div class="step3-flex-col">
            ...
            <div class="live-status-box">
              ...
              <span style="color:#94A3B8; font-size:2.2mm;">เช็กคิวอัตโนมัติทุก 3 วินาที</span>
            </div>
  ...
  console.log(`Saved Balanced HTML poster: ${htmlPath}`);

  const publicHtmlPath = path.join(__dirname, '..', 'public', 'smartaccess_poster_a4.html');
  fs.writeFileSync(publicHtmlPath, html, 'utf8');

  console.log('Rendering Balanced High-Res PNG and Vector PDF with Edge...');
  ...
  try {
    ...
    console.log('=== Balanced Poster with LINE Contact Generated Successfully! ===');
  } catch (err) {
    console.error('Error generating balanced poster:', err);
  } finally {
    await browser.close();
  }
}
