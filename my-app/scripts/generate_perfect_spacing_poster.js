...
async function buildPerfectSpacingPoster() {
  ...
  console.log('Building Perfectly Scaled Full-Page A4 Poster HTML...');
  ...
  <style>
    ...
    * {
    ...
    .poster-canvas {
      ...
      padding: 5.5mm 8.5mm 5.5mm 8.5mm;
      overflow: hidden;
    }
    ...
    .tft-top-bar .brand { color: #E2E8F0; font-size: 1.95mm; font-weight: 800; }
    .tft-top-bar .status { font-size: 1.7mm; padding: 0.2mm 1.2mm; background: rgba(16, 185, 129, 0.2); color: #10B981; border-radius: 0.8mm; font-weight: 700; }
    .tft-body-row {
      display: flex;
      align-items: center;
      padding: 1.2mm 1.6mm;
    ...
    .tft-room-box { flex: 1; }
    .tft-room-box .lbl { color: #94A3B8; font-size: 1.7mm; font-weight: 700; text-transform: uppercase; }
    .tft-room-box .code { color: #38BDF8; font-size: 4.2mm; font-weight: 900; line-height: 1.1; margin-top: 0.2mm; }
    .tft-room-box .sub { color: #CBD5E1; font-size: 1.9mm; margin-top: 0.2mm; }
    .tft-bot-bar {
      background: #0A0B10;
      padding: 0.8mm 1.6mm;
      display: flex;
    ...
    .tft-bot-bar span { color: #64748B; font-size: 1.7mm; }
    ...
    .b-item .ico { color: #38BDF8; font-size: 2.4mm; line-height: 1; margin-top: 0.2mm; }
    ...
    .unlock-txt-top { color: #10B981; font-size: 2.5mm; font-weight: 900; letter-spacing: 0.3px; }
    .unlock-txt-mid { color: #FCD34D; font-size: 1.9mm; font-weight: 800; margin-top: 0.2mm; }
    .unlock-name-pill {
      margin-top: 0.8mm;
      background: rgba(255, 255, 255, 0.08);
...
<body>
  ...
  console.log(`Saved Perfect Spacing HTML poster: ${htmlPath}`);
  ...
  try {
    ...
    console.log('=== Perfect Spacing Poster Generated Successfully! ===');
  } catch (err) {
