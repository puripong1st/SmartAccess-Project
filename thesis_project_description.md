...
3. **วงจรสวิตช์อิเล็กทรอนิกส์ (Relay Module 5V/12V)**: รับสัญญาณ GPIO 12 จากบอร์ด ESP32 เพื่อทำหน้าที่สลับสะพานไฟหน้าสัมผัสจ่ายกระแสไฟ 12V เข้าสู่กลอนแม่เหล็กไฟฟ้า
4. **ลำโพงส่งเสียงเตือน (Active Buzzer)**: ควบคุมระดับเสียงและจังหวะสัญญาณเตือนผ่านพิน GPIO 27 เพื่อแจ้งเตือนเสียงตอบรับ เช่น เสียงตอบรับสิทธิ์ผ่าน หรือเสียงเตือนสิทธิ์ถูกปฏิเสธ
5. **หลอดไฟ LED แสดงสถานะระบบ (Status LEDs)**:
   * **WiFi Status LED (สีน้ำเงิน)**: ต่อกับพิน GPIO 14 สว่างค้างเมื่อเชื่อมต่อ Wi-Fi สำเร็จ และกะพริบถี่เมื่อสัญญาณขัดข้อง
   * **Reject LED (สีแดง)**: ต่อกับพิน GPIO 26 สว่างวาบเมื่อพบผู้ขอเข้าใช้งานที่ถูกปฏิเสธสิทธิ์
6. **กลอนแม่เหล็กไฟฟ้าทนแรงดึงสูง (Electromagnetic Solenoid Lock 280kg / 600lbs)**: ใช้สำหรับการยึดประตูกลอนเข้ากับวงกบประตูเหล็กหรือกระจกของห้องปฏิบัติการ ทำงานในสถาปัตยกรรมแบบ Fail-Safe (เปิดปล่อยล็อกทันทีที่ไม่มีกระแสไฟจ่าย เพื่อความปลอดภัยในกรณีเกิดเพลิงไหม้หรือไฟฟ้าดับฉุกเฉิน)
